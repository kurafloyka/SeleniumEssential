...
public class DriverContext extends Base{
    ...
    public DriverContext(WebDriver webDriver) {
    ...
    public static void scrollToElement(final WebElement elementFindBy){
        ((JavascriptExecutor) DriverContext.webDriver).executeScript("arguments[0].scrollIntoView(true);", elementFindBy);
    ...
    public static void closeWindowByIndex(int index){
